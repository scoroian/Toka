...
import 'package:toka/features/subscription/presentation/skins/futurista/rescue_screen_futurista.dart';
import 'package:toka/features/subscription/presentation/skins/rescue_screen.dart';
...
void main() {
  ...
  testWidgets('wrapper renders v2 by default', (tester) async {
    ...
    await tester.pump();
    expect(find.byType(RescueScreenV2), findsOneWidget);
    expect(find.byType(RescueScreenFuturista), findsNothing);
  });
  ...
  testWidgets('wrapper renders futurista when skin = futurista',
    ...
    expect(find.byType(RescueScreenFuturista), findsOneWidget);
    expect(find.byType(RescueScreenV2), findsNothing);
  });
}
