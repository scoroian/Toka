...
import 'package:toka/features/homes/presentation/skins/futurista/home_settings_screen_futurista.dart';
import 'package:toka/features/homes/presentation/skins/home_settings_screen.dart';
...
void main() {
  ...
  testWidgets('wrapper renders v2 by default', (tester) async {
    ...
    expect(find.byType(HomeSettingsScreenFuturista), findsNothing);
  });
  ...
  testWidgets('wrapper renders futurista when skin = futurista',
    ...
    expect(find.byType(HomeSettingsScreenFuturista), findsOneWidget);
