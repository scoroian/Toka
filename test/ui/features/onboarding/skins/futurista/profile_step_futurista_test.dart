...
import 'package:toka/features/onboarding/presentation/steps/skins/futurista/profile_step_futurista.dart';
import 'package:toka/features/onboarding/presentation/steps/skins/profile_step.dart';
...
void main() {
  ...
  testWidgets('wrapper renders v2 by default', (tester) async {
    ...
    await tester.pump();
    expect(find.byType(ProfileStepV2), findsOneWidget);
  });
  ...
  testWidgets('wrapper renders futurista when skin = futurista',
    ...
    expect(find.byType(ProfileStepFuturista), findsOneWidget);
  });
}
